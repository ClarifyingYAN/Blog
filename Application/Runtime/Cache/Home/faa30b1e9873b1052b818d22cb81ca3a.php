...
<head>
	...
	<style type="text/css">
		#body{background-image: url(/blog/Application/Home/View/Public/picture/winter.jpg);}
	</style>
</head>
<body>
	<div id="body">
		<div class="top">
				...
				<div class="poetry">
					<li id="title">南秦雪</li>
					<li id="author">[唐] &nbsp &nbsp &nbsp 元稹</li>
					<li id="content1">才见岭头云似盖，已惊岩下雪如尘。</li>
					<li id="content2">千峰笋石千株玉，万树松萝万朵云。</li>
				</div>
		</div>
		<div class="middle">
			<div class="nav">
				...
				<a href="winter.html" id="topnav_current" class="winter">冬</a>
				</nav>
				</div>
			<div class="left">
				<article>
