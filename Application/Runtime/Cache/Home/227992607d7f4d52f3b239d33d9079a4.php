...
<head>
	...
	<style type="text/css">
		#body{background-image: url(/blog/Application/Home/View/Public/picture/summer.jpg);}
	</style>
</head>
<body>
	<div id="body">
		<div class="top">
				...
				<div class="poetry">
					<li id="title">小池</li>
					<li id="author">[宋] &nbsp &nbsp &nbsp 杨万里</li>
					<li id="content1">泉眼无声惜细流，树阴照水爱晴柔。</li>
					<li id="content2">小荷才露尖尖角，早有蜻蜓立上头。</li>
				</div>
		</div>
		<div class="middle">
			<div class="nav">
				...
				<a href="summer.html" id="topnav_current" class="summer">夏</a>
